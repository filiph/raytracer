...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    EventTarget: {
      ...
      "%": "CrossOriginServiceWorkerClient|MediaStream|Performance;EventTarget"
    },
    FormElement: {
      "^": "HtmlElement;length=",
      "%": "HTMLFormElement"
  ...
  }], ["", "raytracer_huge.dart",, R, {
    "^": "",
    main: [function() {
      var $async$goto = 0, $async$completer = new P.Completer_Completer$sync(), $async$returnValue, $async$handler = 2, $async$currentError, t1, width, height, e, ctx, t2, t3, t4, t5, scene, rayTracer, t6, t7, clickMap;
          ...
          switch ($async$goto) {
            case 0:
              ...
              if (typeof t1 !== "number") {
                ...
                ;
              width = C.JSNumber_methods.toInt$0(Math.floor(t1 * 0.99));
              ...
              if (typeof t1 !== "number") {
                ...
                ;
              height = C.JSNumber_methods.toInt$0(Math.floor(t1 * 0.99));
              t1 = document;
              e = t1.createElement("canvas");
              J.set$width$x(e, width);
              J.set$height$x(e, height);
              document.body.appendChild(e);
              ctx = J.get$context2D$x(e);
              t1 = $.$get$Surfaces_checkerboard();
              t2 = $.$get$Surfaces_shiny();
              t3 = new M.Vector(3, 2, 4);
              t4 = new M.Camera(t3, null, null, null);
              t3 = new M.Vector(-1, 0.5, 0).$sub(0, t3).norm$0();
              t4.forward = t3;
              t5 = t3.cross$1(new M.Vector(0, -1, 0)).norm$0().$mul(0, 1.5);
              t4.right = t5;
              t4.up = t3.cross$1(t5).norm$0().$mul(0, 1.5);
              scene = new M.Scene([new M.Plane(new M.Vector(0, 1, 0), 0, t1), new M.Sphere(1, 1, new M.Vector(0, 1, -0.25), t2), new M.Sphere(0.5, 0.25, new M.Vector(-1, 0.5, 1.5), t2)], [new M.Light(new M.Vector(-2, 2.5, 0), new M.Color(0.49, 0.07, 0.07)), new M.Light(new M.Vector(1.5, 2.5, 1.5), new M.Color(0.07, 0.07, 0.49)), new M.Light(new M.Vector(1.5, 2.5, -1.5), new M.Color(0.07, 0.49, 0.071)), new M.Light(new M.Vector(0, 3.5, 0), new M.Color(0.21, 0.21, 0.35))], t4);
              rayTracer = new R.CustomRayTracer(5, scene, ctx, width, height, 0, 0);
              t4 = new R.main_moveForward(scene);
              t2 = new R.main_moveBackward(scene);
              t1 = new R.main_moveLeft(scene);
              t5 = new R.main_moveRight(scene);
              t3 = H.setRuntimeTypeInfo(new W._EventStream(window, "keydown", false), [null]);
              H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t3._target, t3._eventType, W._wrapZone(new R.main_closure(rayTracer, t4, t2, t1, t5)), false), [H.getTypeArgumentByIndex(t3, 0)])._tryResume$0();
              t3 = C.JSInt_methods._tdivFast$1(width, 2);
              t6 = H.setRuntimeTypeInfo(new P.Point(t3, 0), [P.$int]);
              t3 = H.setRuntimeTypeInfo(new P.Point(t3, height), [P.$int]);
              t7 = C.JSInt_methods._tdivFast$1(height, 2);
              clickMap = P.LinkedHashMap_LinkedHashMap$_literal([t6, t4, t3, t2, H.setRuntimeTypeInfo(new P.Point(0, t7), [P.$int]), t1, H.setRuntimeTypeInfo(new P.Point(width, t7), [P.$int]), t5], [P.Point, P.$int], P.Function);
              t5 = H.setRuntimeTypeInfo(new W._EventStream(window, "click", false), [null]);
              H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t5._target, t5._eventType, W._wrapZone(new R.main_closure0(rayTracer, clickMap)), false), [H.getTypeArgumentByIndex(t5, 0)])._tryResume$0();
              $async$goto = 3;
    ...
    }, "call$0", "raytracer_huge__main$closure", 0, 0, 0],
    CustomRayTracer: {
      "^": "Object;_maxDepth,scene,ctx,screenWidth,screenHeight,activeJobId,count",
      ...
      _traceRay$3: function(ray, scene, depth) {
        var isect, t1, d, pos, normal, reflectDir, naturalColor;
        ...
        if (isect == null)
          ...
          t1 = isect.ray;
          d = t1.dir;
          pos = d.$mul(0, isect.dist).$add(0, t1.start);
          t1 = isect.thing;
          normal = t1.normal$1(pos);
          reflectDir = d.$sub(0, normal.$mul(0, normal.dot$1(d)).$mul(0, 2));
          naturalColor = $.$get$Color_background().$add(0, this._getNaturalColor$5(t1, pos, normal, reflectDir, scene));
          return naturalColor.$add(0, depth >= this._maxDepth ? $.$get$Color_grey() : this._traceRay$3(new M.Ray(pos, reflectDir), scene, depth + 1).scale$1(0, t1.get$surface()._reflect$1(pos)));
        }
      },
      _getNaturalColor$5: function(thing, pos, norm, rd, scene) {
        return C.JSArray_methods.fold$2(scene.lights, $.$get$Color_defaultColor(), new R.CustomRayTracer__getNaturalColor_closure(this, thing, pos, norm, rd, scene));
      },
      renderAsync$0: function() {
        var $async$goto = 0, $async$completer = new P.Completer_Completer$sync(), $async$returnValue, $async$handler = 2, $async$currentError, $async$self = this, t1, t2, t3, t4, time, t5, t6, t7, x, y, drawingColor, size, t8, pixels, _i, pixel;
        var $async$renderAsync$0 = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
          if ($async$errorCode === 1) {
            $async$currentError = $async$result;
            $async$goto = $async$handler;
          }
          while (true)
            switch ($async$goto) {
              case 0:
                // Function start
                t1 = new R.CustomRayTracer_renderAsync_getColor($async$self, new R.CustomRayTracer_renderAsync_getPoint($async$self));
                t2 = $.$get$CustomRayTracer__random();
                ...
                t6 = $async$self.screenHeight;
                t7 = $async$self.ctx;
              case 3:
                // while condition
                if (!(J.$ge$n(t4.call$1($async$self.count), 2.8) && t3.call$0() === true)) {
                  // goto after while
                  $async$goto = 4;
                  break;
                } else
                ...
                x = t2.nextInt$1(t5);
                y = t2.nextInt$1(t6);
                drawingColor = t1.call$2(x, y).toDrawingColor$0();
                t7.toString;
                t7.fillStyle = "rgba(" + drawingColor.r + ", " + drawingColor.g + ", " + drawingColor.b + ", 1)";
                size = C.JSNumber_methods.toInt$0(Math.floor(t4.call$1($async$self.count)));
                t8 = C.JSInt_methods._tdivFast$1(size, 2);
                t7.fillRect(x - t8, y - t8, size, size);
                ++$async$self.count;
                t8 = window.performance.now();
                if (typeof t8 !== "number") {
                  $async$returnValue = t8.$sub();
                  // goto return
                  $async$goto = 1;
                  break;
                } else
                ...
                if (typeof time !== "number") {
                  $async$returnValue = H.iae(time);
                  // goto return
                  $async$goto = 1;
                  break;
                } else
                  ;
                $async$goto = t8 - time > 12 ? 5 : 6;
                break;
              case 5:
                // then
                $async$goto = 7;
                return P._asyncHelper(C.Window_methods.get$animationFrame(window), $async$renderAsync$0, $async$completer);
              case 7:
                // returning from await.
                time = window.performance.now();
              case 6:
              ...
              case 4:
                ...
                if (t3.call$0() !== true) {
                  ...
                  ;
                pixels = P.List_List$generate(t6 * t5, new R.CustomRayTracer_renderAsync_closure(), true, P.$int);
                C.JSArray_methods.shuffle$1(pixels, t2);
                t2 = pixels.length, _i = 0;
              case 8:
                // for condition
                if (!(_i < pixels.length)) {
                  // goto after for
                ...
                if (typeof pixel !== "number") {
                  $async$returnValue = pixel.$mod();
                  // goto return
                  $async$goto = 1;
                  break;
                } else
                  ;
                x = C.JSNumber_methods.$mod(pixel, t5);
                y = C.JSNumber_methods.$tdiv(pixel, t5);
                drawingColor = t1.call$2(x, y).toDrawingColor$0();
                t7.toString;
                t7.fillStyle = "rgba(" + drawingColor.r + ", " + drawingColor.g + ", " + drawingColor.b + ", 1)";
                t7.fillRect(x, y, 1, 1);
              ...
              case 9:
                // for update
                pixels.length === t2 || (0, H.throwConcurrentModificationError)(pixels), ++_i;
                // goto for condition
                $async$goto = 8;
                break;
              case 10:
        ...
        return P._asyncHelper(null, $async$renderAsync$0, $async$completer, null);
      }
    },
    CustomRayTracer__getNaturalColor_closure: {
      "^": "Closure:16;$this,thing,pos,norm,rd,scene",
      call$2: function(col, light) {
        var t1, ldis, livec, neatIsect, illum, lcolor, specular, t2, t3, scolor;
        t1 = this.pos;
        ldis = light.get$pos().$sub(0, t1);
        livec = ldis.norm$0();
        neatIsect = this.$this._testRay$2(new M.Ray(t1, livec), this.scene);
    ...
    CustomRayTracer_renderAsync_getPoint: {
      "^": "Closure:17;$this",
      call$3: function(x, y, camera) {
        var t1 = this.$this;
        return camera.forward.$add(0, camera.right.$mul(0, new R.CustomRayTracer_renderAsync_getPoint_recenterX(t1).call$1(x))).$add(0, camera.up.$mul(0, new R.CustomRayTracer_renderAsync_getPoint_recenterY(t1).call$1(y))).norm$0();
      }
    },
    CustomRayTracer_renderAsync_getPoint_recenterX: {
      "^": "Closure:6;$this",
      call$1: function(x) {
        var t1 = this.$this.screenHeight;
        return (x - t1 / 2) / 2 / t1;
      }
    },
    CustomRayTracer_renderAsync_getPoint_recenterY: {
      "^": "Closure:6;$this",
      call$1: function(y) {
        var t1 = this.$this.screenHeight;
        return -(y - t1 / 2) / 2 / t1;
    ...
    CustomRayTracer_renderAsync_getColor: {
      "^": "Closure:18;$this,getPoint",
      call$2: function(x, y) {
        var t1, t2, t3;
        t1 = this.$this;
        t2 = t1.scene;
        t3 = t2.camera;
        return t1._traceRay$3(new M.Ray(t3.pos, this.getPoint.call$3(x, y, t3)), t2, 0);
      }
    },
    CustomRayTracer_renderAsync_thisJobIsStillActive: {
      "^": "Closure:19;$this,thisJobId",
      call$0: function() {
        return this.$this.activeJobId === this.thisJobId;
      }
    },
    CustomRayTracer_renderAsync_sizeFromCount: {
      "^": "Closure:20;logMax",
      call$1: function(count) {
        return this.logMax - Math.log(H.checkNum(count + 10));
      }
    },
    CustomRayTracer_renderAsync_closure: {
      "^": "Closure:2;",
      call$1: function(i) {
        return i;
      }
    ...
    main_moveForward: {
      "^": "Closure:1;scene",
      call$0: function() {
        var t1 = this.scene.camera;
        t1.pos = t1.pos.$add(0, t1.forward);
      }
    },
    main_moveBackward: {
      "^": "Closure:1;scene",
      call$0: function() {
        var t1 = this.scene.camera;
        t1.pos = t1.pos.$sub(0, t1.forward);
      }
    },
    main_moveLeft: {
      "^": "Closure:1;scene",
    ...
    main_moveRight: {
      ...
      call$0: function() {
        var t1 = this.scene.camera;
        t1.pos = t1.pos.$add(0, t1.right);
      }
    },
    main_closure: {
      "^": "Closure:2;rayTracer,moveForward,moveBackward,moveLeft,moveRight",
      call$1: function(e) {
        var t1;
        switch (J.get$keyCode$x(e)) {
          case 87:
            this.moveForward.call$0();
            break;
          case 83:
            this.moveBackward.call$0();
            break;
          case 65:
            this.moveLeft.call$0();
            break;
          case 68:
            this.moveRight.call$0();
            break;
          default:
            return;
        }
    ...
    main_closure0: {
      "^": "Closure:2;rayTracer,clickMap",
      call$1: function(e) {
        var t1, t2, winningPoint, t3, point;
        t1 = this.clickMap;
        t2 = t1.get$keys();
        winningPoint = t2.get$first(t2);
        for (t2 = t1.get$keys(), t2 = t2.get$iterator(t2), t3 = J.getInterceptor$x(e); t2.moveNext$0();) {
          point = t2.get$current();
          if (point.distanceTo$1(t3.get$client(e)) < winningPoint.distanceTo$1(t3.get$client(e)))
            winningPoint = point;
        }
        t1.$index(0, winningPoint).call$0();
        t1 = this.rayTracer;
        t1.count = 0;
        t1.renderAsync$0();
      }
    }
  }, 1], ["ts_raytracer", "raytracer.dart",, M, {
    "^": "",
    Vector: {
      "^": "Object;x>,y>,z>",
      $mul: function(_, k) {
        var t1 = J.getInterceptor$ns(k);
        return new M.Vector(t1.$mul(k, this.x), t1.$mul(k, this.y), t1.$mul(k, this.z));
      },
      $sub: function(_, o) {
        var t1 = J.getInterceptor$x(o);
        return new M.Vector(J.$sub$n(this.x, t1.get$x(o)), J.$sub$n(this.y, t1.get$y(o)), J.$sub$n(this.z, t1.get$z(o)));
      },
      $add: function(_, o) {
        var t1 = J.getInterceptor$x(o);
        return new M.Vector(J.$add$ns(this.x, t1.get$x(o)), J.$add$ns(this.y, t1.get$y(o)), J.$add$ns(this.z, t1.get$z(o)));
      },
      dot$1: function(o) {
        return J.$add$ns(J.$add$ns(J.$mul$ns(this.x, o.x), J.$mul$ns(this.y, o.y)), J.$mul$ns(this.z, o.z));
      },
      mag$0: function() {
        var t1, t2, t3;
        t1 = this.x;
      ...
      cross$1: function(o) {
        ...
        return new M.Vector(J.$sub$n(t3.$mul(t1, t2), t6.$mul(t4, t5)), J.$sub$n(t6.$mul(t4, t7), t9.$mul(t8, t2)), J.$sub$n(t9.$mul(t8, t5), t3.$mul(t1, t7)));
      }
    },
    Color: {
      "^": "Object;r>,g<,b<",
    ...
    Sphere: {
      ...
      normal$1: function(pos) {
        return pos.$sub(0, this.center).norm$0();
      },
      intersect$1: function(ray) {
        ...
        if (J.$eq$(dist, 0))
          ...
          return new M.Intersection(this, ray, dist);
      }
    },
    Plane: {
      ...
      intersect$1: function(ray) {
        ...
        if (t2.$gt(denom, 0))
          ...
          if (typeof t2 !== "number")
            return H.iae(t2);
          return new M.Intersection(this, ray, t1 / t2);
        }
      },
      normal$1: function(pos) {
        return this.norm;
    ...
    closure2: {
      "^": "Closure:22;",
      call$1: function(pos) {
        if (C.JSInt_methods.$mod(J.floor$0$n(pos.z) + J.floor$0$n(pos.x), 2) !== 0)
          return $.$get$Color_white();
        else
...
;
  ...
  (function(lazies) {
    ...
    return [];
  }, "_toStringVisiting", "CustomRayTracer__random", "$get$CustomRayTracer__random", function() {
    return P.Random_Random(null);
  }, "CustomRayTracer__random", "Color_white", "$get$Color_white", function() {
  ...
  $ = new Isolate();
  init.metadata = [null];
  init.types = [{func: 1}, {func: 1, v: true}, {func: 1, args: [,]}, {func: 1, v: true, args: [{func: 1, v: true}]}, {func: 1, args: [, P.StackTrace]}, {func: 1, ret: P.String, args: [P.$int]}, {func: 1, ret: P.num, args: [,]}, {func: 1, args: [, P.String]}, {func: 1, args: [P.String]}, {func: 1, args: [{func: 1, v: true}]}, {func: 1, args: [P.$int,,]}, {func: 1, v: true, args: [,], opt: [P.StackTrace]}, {func: 1, args: [,], opt: [,]}, {func: 1, v: true, args: [P.Object], opt: [P.StackTrace]}, {func: 1, v: true, args: [, P.StackTrace]}, {func: 1, args: [,,]}, {func: 1, args: [, M.Light]}, {func: 1, ret: M.Vector, args: [P.$int, P.$int, M.Camera]}, {func: 1, ret: M.Color, args: [,,]}, {func: 1, ret: P.bool}, {func: 1, ret: P.num, args: [P.$int]}, {func: 1, args: [P.num]}, {func: 1, args: [M.Vector]}];
  ...
  (function(callback) {
    ...
    if (typeof dartMainRunner === "function")
      dartMainRunner(function(a) {
        H.startRootIsolate(R.raytracer_huge__main$closure(), a);
      }, []);
    else
      (function(a) {
        H.startRootIsolate(R.raytracer_huge__main$closure(), a);
