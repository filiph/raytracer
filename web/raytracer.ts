...
function main() {
    ...
    let canvas : HTMLCanvasElement = document.querySelector("#ts-canvas");
    let info = document.querySelector("#ts-info");
    let button : HTMLButtonElement = document.querySelector("#ts-button");
