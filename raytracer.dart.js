...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    main: [function() {
      ...
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new M.main_closure(t1, 256, 256, canvas, info, button, 1, [])), false), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
    }, "call$0", "ts_raytracer__main$closure", 0, 0, 1],
    Vector: {
      "^": "Object;x>,y>,z>",
      $mul: function(_, k) {
          ...
          while (true)
            switch ($async$goto) {
              ...
              case 3:
                ...
                t6 = new M.Vector(3, 2, 4);
                t7 = new M.Camera(t6, null, null, null);
                t6 = new M.Vector(-1, 0.5, 0).$sub(0, t6).norm$0();
                t7.forward = t6;
  ...
  (function(callback) {
    ...
    if (typeof dartMainRunner === "function")
      dartMainRunner(function(a) {
        H.startRootIsolate(M.ts_raytracer__main$closure(), a);
      }, []);
    else
      (function(a) {
        H.startRootIsolate(M.ts_raytracer__main$closure(), a);
